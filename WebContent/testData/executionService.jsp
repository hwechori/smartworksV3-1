		...
		//web Service
				...
				for(String str : mappingStr){
					...
					if(mappingServiceId.equals(objId)){
						WebService webService = SwManagerFactory.getInstance().getWebManager().getWebService(userId,targetServiceId,"all");
						...
						WebServiceParameter[] params = webService.getWebServiceParameters();
