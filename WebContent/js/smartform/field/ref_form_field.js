...
SmartWorks.FormRuntime.RefFormFieldBuilder.build = function(config) {
	...
	if(readOnly){
		...
		$refForm = $('<div class="form_value form_value_max_width" style="width:' + valueWidth + '%"><div class="ico_work_space"><input readonly="readonly" type="text" name="' + id + '"' + required + '><a href="#" class="js_workitmepicker_button"><span class="ico_fb_work"></span></a></div></div>');
	}
