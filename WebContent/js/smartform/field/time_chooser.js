...
SmartWorks.FormRuntime.TimeChooserBuilder.build = function(config) {
	...
	if(readOnly){
		...
		$text = $('<div class="form_value" style="width:' + valueWidth + '%"><div class="ico_time_space form_time_input"><input readonly="readonly" type="text" name="' + id + '"' + required + '><span class="ico_time"></span></div></div>').attr('value', value);
	}
