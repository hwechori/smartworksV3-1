...
SmartWorks.FormRuntime.UserFieldBuilder.build = function(config) {
	...
	if (userId !== "") {
		...
		var $html = $('<div class="form_value form_value_max_width" style="width:' + valueWidth + '%"> <div class="ico_user_space">\
					<div ' + required + '">\
					...
					<div class="js_community_list commu_list" style="display: none"></div> <span class="ico_fb_user"></span></div></div>');
