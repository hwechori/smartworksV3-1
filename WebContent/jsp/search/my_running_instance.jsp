...
<%
	...
	Instance[] instances = smartWorks.searchMyRunningInstance(key);
%>
...
<ul>
	...
	%>
	<li><a href="<%=targetContent%>?cid=<%=workContext%>" class="js_content" ><img class="<%=iconType%>" border="0"><%=work.getFullpathName()%> <%=workInstance.getSubject() %></a>
	</li>
	<%
		}
	%>
