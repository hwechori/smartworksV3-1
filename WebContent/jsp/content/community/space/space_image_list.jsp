...
<!-- 컨텐츠 레이아웃-->
<div class="section_portlet js_space_image_list_page js_instance_list_page" spaceId="<%=spaceId%>">
...
<%--  					<jsp:include page="/jsp/content/work/report/work_report.jsp"/>
 --%>				</div>
				...
				<div class="list_title_space js_work_list_title margin_t15">
					<div class="title"><fmt:message key="common.title.picture_list" /></div>
				...
				<!-- 목록 테이블 -->
 				<div class="list_contents">
					<div id='picture_instance_list_page'>
 						<jsp:include page="/jsp/content/community/space/image_instance_list.jsp"/>
					</div>
				</div>
				<!-- 목록 테이블 //-->
