...
<div class="tab js_space_tab_dayly_page" userId="<%=user.getId() %>" startDate="<%=startDateStr%>">
	...
	<div class="option_section">
		...
		<select class="js_space_select_scope">
			<option selected><fmt:message key="space.title.tab_dayly"/></option>
			<option value="space_tab_weekly.sw?startDate=<%=selectedDateStr %>"><fmt:message key="space.title.tab_weekly"/></option>
			<option value="space_tab_monthly.sw?startDate=<%=selectedDateStr%>"><fmt:message key="space.title.tab_monthly"/></option>
		</select>
	</div>
</div>
<!--탭//-->
