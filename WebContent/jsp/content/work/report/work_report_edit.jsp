...
<!--  전체 레이아웃 -->
	...
	<div class="glo_btn_space js_button_space">
		<div class="float_right padding_r10">
			...
			<span class="btn_gray" <%if(report.isSystemReport()){ %>style="display:none" <%} %>> 
			...
			<span class="btn_gray js_button_save"  <%if(report.isSystemReport()){ %>style="display:none" <%} %>> 
		...
		<div id="sw_progress_span" class="float_right form_space" ></div>
