...
<div class="up_wrap">
	<div class="form_wrap up up_padding">
		...
		<div class="contents_space">
			...
			<!-- 업무 정의 영역 -->
			<div class="">이 회의록은 신제품기획 TFT 회의록입니다</div>
			...
			<div class="txt_btn">
				...
				<div class="float_right padding_l10">
					<span class="btn_gray"> <span class="Btn01Start"></span> <span
						class="Btn01Center">수정하기</span> <span class="Btn01End"></span> </span>
				</div>

				<div class="float_right">
					사용설명서 : <a href="">동영상 보기</a> <a href="">웹설명서 보기</a>
				</div>
		...
		<div class="contents_space">
			...
			<div class="det_contents">
				<table>
					...
					<tbody>
						<tr>
							<td><img src="images/im_iworkscreen.gif" width="349"
								height="289" />
							</td>
							<td>1. 업무설명이 들어갑니다<br /> 1. 업무설명이 들어갑니다<br /> 2. 업무설명이
								들어갑니다<br /> 3. 업무설명이 들어갑니다<br /> 4. 업무설명이 들어갑니다<br /> 5.
								업무설명이 들어갑니다</td>
						</tr>
					</tbody>
				</table>
			...
			<div class="replay_upload">
				<textarea class="up_textarea" rows="5" cols=""
					name="txtaEventContent">궁금한 점을 올려주세요!</textarea>
			</div>
			<!-- 댓글 //-->
			...
			<div class="up list_contents">
				<table>
					...
					<tbody>
						...
						<tr>
							<td><img src="images/pic_size_m29.jpg" />
							</td>
