...
<%
	...
	InstanceInfoList instanceList = smartWorks.getImageInstanceList(cid, params);
%>
...
<table>
	...
	%>
		...
		if(instanceList.getInstanceDatas() != null) {
			ImageInstanceInfo[] instanceInfos = (ImageInstanceInfo[])instanceList.getInstanceDatas();
			for (ImageInstanceInfo instanceInfo : instanceInfos) {
		%>
				<tr>
					<td>
