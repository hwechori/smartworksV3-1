...
<div id="up_event">
	...
	<div class="input_1line">
		...
		<div class="float_left txt_btn">
			<a href="" class="space_l"
				...
				style="display: none" href="" class="space_l"
				onclick="$(this).hide().siblings().show().parent().next('div').toggle(); return false;"><fmt:message
		...
		<div class="float_left txt_btn">
			<a href="" class="space_l"
				onclick="$(this).parent().next('div').toggle(); return false;"><input
				type="checkbox"> <fmt:message
					key="common.upload.button.set_alarm" /> </a>
		</div>
		<div></div>
		...
		<div class="float_left txt_btn">
			<a href="" class="space_l"
				onclick="$(this).parent().next('div').toggle(); return false;"><fmt:message
					key="common.upload.button.set_repeat" /> </a>
		</div>
		<div></div>
	...
	<div class="input_1line js_user_name">
		...
		<input class="up js_auto_complete" href="user_name.sw" type="text"
			title=""
