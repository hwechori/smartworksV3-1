...
<!-- Name 			: file_field.jsp											 -->
<!-- Description	: 업무목록 페이지들의 상세필터에서 조건이 파일인 연산자 구성  			 -->
...
<%
	...
	// 파일이름에 있는 특수문자 스페이스등 때문에 엔코딩 디코딩이 필요함...
...
<input name="hdnFieldType" type="hidden" value="<%=FormField.TYPE_FILE %>"/>
...
<!--  비교값이 문자인경우여서, 입력박스를 제공.. -->
<span class="str_field"> 
	<input class="fieldline required" type="text" name="txtFilterStringOperand" value="<%if (operandValue != null) {%><%=operandValue%><%}%>"> 
</span>
