...
<div class="start_worksinput js_start_work_page">
	...
	<div class="input_size srch">
		...
		<div class="srch_ico_w js_srch_x js_pop_all_works"></div>
	</div>
...
<!-- 선택된 업무 화면이 나타나는 곳 -->
<div class="form_wrap up up_padding js_upload_form_detail" id="form_works" style="display: none"></div>
<!-- 새업무등록하기위한 업무 검색과 업무선택 트리 화면들 //-->
