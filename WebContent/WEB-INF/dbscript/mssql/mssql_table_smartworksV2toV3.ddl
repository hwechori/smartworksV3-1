...
CREATE TABLE lnklist (
    ...
    lnktype varchar(100),
    lnkcorr varchar(200),
    lnkstatus varchar(50),
    lnkdesc text,
    primary key(lnkobjid)
);

CREATE TABLE lnklistextprop (
    lnkobjid varchar(100) NOT NULL,
    tskname varchar(100),
...
CREATE TABLE lnklistitem (
    lnkobjid varchar(100) NOT NULL,
    lnktype varchar(100),
    lnkref varchar(100),
    lnklabel varchar(100),
    lnkexpr text,
    lnkseq int NOT NULL,
    primary key(lnkobjid, lnkseq)
);
...
CREATE TABLE lnkmap (
    ...
    lnkmodifydate datetime,
    lnktype varchar(200),
    lnkfromtype varchar(200),
    lnkfromref varchar(200),
    lnktotype varchar(200),
    lnktoref varchar(200),
    primary key(lnkobjid)
);

CREATE TABLE lnkmapextprop (
    lnkobjid varchar(100) NOT NULL,
    tskname varchar(100),
    tskvalue varchar(100),
    lnkseq int NOT NULL,
