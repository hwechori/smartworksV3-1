 ...
 * </copyright>
 *
 * $Id: DataFieldsImpl.java,v 1.1 2009/12/22 06:17:53 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.DataFieldsImpl#getDataField <em>Data Field</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.DataFieldsImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.DataFieldsImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataFieldsImpl extends DataObjectBase implements DataFields
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getDataFields();
  }
