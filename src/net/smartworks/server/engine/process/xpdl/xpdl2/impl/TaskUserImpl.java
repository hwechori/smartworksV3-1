 ...
 * </copyright>
 *
 * $Id: TaskUserImpl.java,v 1.1 2009/12/22 06:17:53 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getPerformers <em>Performers</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getMessageIn <em>Message In</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getMessageOut <em>Message Out</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getWebServiceOperation <em>Web Service Operation</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getImplementation <em>Implementation</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TaskUserImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TaskUserImpl extends DataObjectBase implements TaskUser
{
  ...
  public final static int WEB_SERVICE_OPERATION = 3;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_MESSAGE_IN = 1;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_MESSAGE_OUT = 2;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_WEB_SERVICE_OPERATION = 3;
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getTaskUser();
  }
