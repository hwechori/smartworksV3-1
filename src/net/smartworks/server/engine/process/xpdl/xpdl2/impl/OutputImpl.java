 ...
 * </copyright>
 *
 * $Id: OutputImpl.java,v 1.1 2009/12/22 06:17:33 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.OutputImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.OutputImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.OutputImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutputImpl extends DataObjectBase implements Output
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getOutput();
  }
