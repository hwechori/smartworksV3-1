 ...
 * </copyright>
 *
 * $Id: ResponsiblesImpl.java,v 1.1 2009/12/22 06:17:34 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ResponsiblesImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ResponsiblesImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ResponsiblesImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponsiblesImpl extends DataObjectBase implements Responsibles
{
  ...
  /**
   * The internal feature id for the '<em><b>Responsible</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getResponsibles();
  }
  ...
  public List getResponsible()
  {
    if (responsible == null)
    {
      responsible = createPropertyList(ListKind.CONTAINMENT, Responsible.class, RESPONSIBLE, 0);
    }
    return responsible;
  }
  /**
  ...
  public ChangeContext inverseRemove(Object otherEnd, int propertyIndex, ChangeContext changeContext)
  {
    ...
    {
      case RESPONSIBLE:
        return removeFromList(getResponsible(), otherEnd, changeContext);
      case ANY:
