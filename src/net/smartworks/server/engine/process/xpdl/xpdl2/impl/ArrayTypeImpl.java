 ...
 * </copyright>
 *
 * $Id: ArrayTypeImpl.java,v 1.1 2009/12/22 06:17:55 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getBasicType <em>Basic Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getSchemaType <em>Schema Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getExternalReference <em>External Reference</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getRecordType <em>Record Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getUnionType <em>Union Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getEnumerationType <em>Enumeration Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getArrayType <em>Array Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getListType <em>List Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getLowerIndex <em>Lower Index</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getUpperIndex <em>Upper Index</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ArrayTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ArrayTypeImpl extends DataObjectBase implements ArrayType
{
  ...
  public final static int LOWER_INDEX = 9;

  public final static int UPPER_INDEX = 10;
  ...
  /**
   * The internal feature id for the '<em><b>Lower Index</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */ 
  public final static int INTERNAL_LOWER_INDEX = 9;

  /**
   * The internal feature id for the '<em><b>Upper Index</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */ 
  public final static int INTERNAL_UPPER_INDEX = 10;
  ...
  protected int internalConvertIndex(int internalIndex)
  {
    switch (internalIndex)
    {
      ...
      case INTERNAL_LOWER_INDEX: return LOWER_INDEX;
      case INTERNAL_UPPER_INDEX: return UPPER_INDEX;
   ...
   * @ordered
   */
  protected static final String LOWER_INDEX_DEFAULT_ = null;
   ...
   * @ordered
   */
  protected String lowerIndex = LOWER_INDEX_DEFAULT_;

  /**
   * This is true if the Lower Index attribute has been set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  protected boolean lowerIndex_set_ = false;
   ...
   * @ordered
   */
  protected static final String UPPER_INDEX_DEFAULT_ = null;
   ...
   * @ordered
   */
  protected String upperIndex = UPPER_INDEX_DEFAULT_;

  /**
   * This is true if the Upper Index attribute has been set.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  protected boolean upperIndex_set_ = false;
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getArrayType();
  }
  ...
  public void setLowerIndex(String newLowerIndex)
  {
    ...
    boolean oldLowerIndex_set_ = lowerIndex_set_;
    lowerIndex_set_ = true;
    if (isNotifying())
      notify(ChangeKind.SET, INTERNAL_LOWER_INDEX, oldLowerIndex, lowerIndex, !oldLowerIndex_set_);
  }
   ...
   * @generated
   */
  public void unsetLowerIndex()
  {
    String oldLowerIndex = lowerIndex;
    boolean oldLowerIndex_set_ = lowerIndex_set_;
    lowerIndex = LOWER_INDEX_DEFAULT_;
    lowerIndex_set_ = false;
    if (isNotifying())
      notify(ChangeKind.UNSET, INTERNAL_LOWER_INDEX, oldLowerIndex, LOWER_INDEX_DEFAULT_, oldLowerIndex_set_);
  }
   ...
   * @generated
   */
  public boolean isSetLowerIndex()
  {
    return lowerIndex_set_;
  }
  ...
  public void setUpperIndex(String newUpperIndex)
  {
    ...
    boolean oldUpperIndex_set_ = upperIndex_set_;
    upperIndex_set_ = true;
    if (isNotifying())
      notify(ChangeKind.SET, INTERNAL_UPPER_INDEX, oldUpperIndex, upperIndex, !oldUpperIndex_set_);
  }
   ...
   * @generated
   */
  public void unsetUpperIndex()
  {
    String oldUpperIndex = upperIndex;
    boolean oldUpperIndex_set_ = upperIndex_set_;
    upperIndex = UPPER_INDEX_DEFAULT_;
    upperIndex_set_ = false;
    if (isNotifying())
      notify(ChangeKind.UNSET, INTERNAL_UPPER_INDEX, oldUpperIndex, UPPER_INDEX_DEFAULT_, oldUpperIndex_set_);
  }
   ...
   * @generated
   */
  public boolean isSetUpperIndex()
  {
    return upperIndex_set_;
  }
  ...
  public boolean isSet(int propertyIndex)
  {
    switch (propertyIndex)
    {
      ...
      case LOWER_INDEX:
        return isSetLowerIndex();
      case UPPER_INDEX:
        return isSetUpperIndex();
      case ANY_ATTRIBUTE:
  ...
  public String toString()
  {
    ...
    if (lowerIndex_set_) result.append(lowerIndex); else result.append("<unset>");
    result.append(", UpperIndex: ");
    if (upperIndex_set_) result.append(upperIndex); else result.append("<unset>");
