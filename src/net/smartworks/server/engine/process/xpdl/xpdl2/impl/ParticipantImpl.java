 ...
 * </copyright>
 *
 * $Id: ParticipantImpl.java,v 1.1 2009/12/22 06:17:43 kmyu Exp $
 */
...
import net.smartworks.server.engine.process.xpdl.xpdl2.ParticipantType;
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getParticipantType <em>Participant Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getExternalReference <em>External Reference</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getExtendedAttributes <em>Extended Attributes</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ParticipantImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParticipantImpl extends DataObjectBase implements Participant
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getParticipant();
  }
