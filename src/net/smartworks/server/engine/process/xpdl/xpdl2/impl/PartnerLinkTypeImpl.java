 ...
 * </copyright>
 *
 * $Id: PartnerLinkTypeImpl.java,v 1.1 2009/12/22 06:17:34 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PartnerLinkTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PartnerLinkTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PartnerLinkTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PartnerLinkTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PartnerLinkTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PartnerLinkTypeImpl extends DataObjectBase implements PartnerLinkType
{
  ...
  /**
   * The internal feature id for the '<em><b>Role</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */ 
  public final static int INTERNAL_ROLE = 0;
  ...
  protected int internalConvertIndex(int internalIndex)
  {
    ...
    {
      case INTERNAL_ROLE: return ROLE;
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getPartnerLinkType();
  }
  ...
  public List getRole()
  {
    if (role == null)
    {
      role = createPropertyList(ListKind.CONTAINMENT, Role.class, ROLE, 0);
    }
    return role;
  }
  /**
  ...
  public ChangeContext inverseRemove(Object otherEnd, int propertyIndex, ChangeContext changeContext)
  {
    ...
    {
      case ROLE:
        return removeFromList(getRole(), otherEnd, changeContext);
      case ANY:
