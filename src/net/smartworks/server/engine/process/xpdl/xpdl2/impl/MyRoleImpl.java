 ...
 * </copyright>
 *
 * $Id: MyRoleImpl.java,v 1.1 2009/12/22 06:17:48 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.MyRoleImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.MyRoleImpl#getRoleName <em>Role Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.MyRoleImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MyRoleImpl extends DataObjectBase implements MyRole
{

  public final static int ANY = -1;

  public final static int ROLE_NAME = 0;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_ROLE_NAME = 1;
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getMyRole();
  }
