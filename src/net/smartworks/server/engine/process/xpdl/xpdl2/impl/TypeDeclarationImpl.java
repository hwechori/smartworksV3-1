 ...
 * </copyright>
 *
 * $Id: TypeDeclarationImpl.java,v 1.1 2009/12/22 06:17:27 kmyu Exp $
 */
...
import net.smartworks.server.engine.process.xpdl.xpdl2.TypeDeclaration;
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getBasicType <em>Basic Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getDeclaredType <em>Declared Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getSchemaType <em>Schema Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getExternalReference <em>External Reference</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getRecordType <em>Record Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getUnionType <em>Union Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getEnumerationType <em>Enumeration Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getArrayType <em>Array Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getListType <em>List Type</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getExtendedAttributes <em>Extended Attributes</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TypeDeclarationImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeDeclarationImpl extends DataObjectBase implements TypeDeclaration
{
   ...
   * @ordered
   */ 
  public final static int INTERNAL_ANY = 11;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_ID = 12;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_NAME = 13;
   ...
   * @ordered
   */ 
  public final static int INTERNAL_ANY_ATTRIBUTE = 14;
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getTypeDeclaration();
  }
