 ...
 * </copyright>
 *
 * $Id: ActualParametersImpl.java,v 1.1 2009/12/22 06:17:50 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ActualParametersImpl#getActualParameter <em>Actual Parameter</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ActualParametersImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.ActualParametersImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActualParametersImpl extends DataObjectBase implements ActualParameters
{
  ...
  /**
   * The internal feature id for the '<em><b>Actual Parameter</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getActualParameters();
  }
  ...
  public List getActualParameter()
  {
    ...
    {
      actualParameter = createPropertyList(ListKind.CONTAINMENT, ExpressionType.class, ACTUAL_PARAMETER, 0);
    }
  ...
  public ChangeContext inverseRemove(Object otherEnd, int propertyIndex, ChangeContext changeContext)
  {
    switch (propertyIndex)
    {
      case ACTUAL_PARAMETER:
        return removeFromList(getActualParameter(), otherEnd, changeContext);
      case ANY:
