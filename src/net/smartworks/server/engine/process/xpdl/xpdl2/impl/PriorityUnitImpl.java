 ...
 * </copyright>
 *
 * $Id: PriorityUnitImpl.java,v 1.1 2009/12/22 06:17:41 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PriorityUnitImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.PriorityUnitImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PriorityUnitImpl extends DataObjectBase implements PriorityUnit
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getPriorityUnit();
  }
