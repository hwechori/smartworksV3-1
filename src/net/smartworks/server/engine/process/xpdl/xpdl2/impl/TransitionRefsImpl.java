 ...
 * </copyright>
 *
 * $Id: TransitionRefsImpl.java,v 1.1 2009/12/22 06:17:35 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefsImpl#getTransitionRef <em>Transition Ref</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefsImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefsImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransitionRefsImpl extends DataObjectBase implements TransitionRefs
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getTransitionRefs();
  }
