 ...
 * </copyright>
 *
 * $Id: CategoryImpl.java,v 1.1 2009/12/22 06:17:51 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.CategoryImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.CategoryImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.CategoryImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.CategoryImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CategoryImpl extends DataObjectBase implements Category
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getCategory();
  }
