 ...
 * </copyright>
 *
 * $Id: TransitionRefImpl.java,v 1.1 2009/12/22 06:17:31 kmyu Exp $
 */
 ...
 * <ul>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefImpl#getAny <em>Any</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefImpl#getId <em>Id</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.smartworks.server.engine.process.xpdl.xpdl2.impl.TransitionRefImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TransitionRefImpl extends DataObjectBase implements TransitionRef
{
  ...
  {
    return ((Xpdl2FactoryImpl)Xpdl2Factory.INSTANCE).getTransitionRef();
  }
