...
public class PrcProcessInstVariable extends MisObject {
	
	public PrcProcessInstVariable() {
		super();
	}
	
	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(PrcProcessVariable.class);
	protected static final String PREFIX = "Prc";
	
	private static final String NAME = CommonUtil.toName(PrcProcessVariable.class, PREFIX);
