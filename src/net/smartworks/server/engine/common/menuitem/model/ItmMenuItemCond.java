...
public class ItmMenuItemCond extends MisObjectCond {

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(ItmMenuItemCond.class);

	protected static final String PREFIX = "Itm";
	private static final String NAME = CommonUtil.toName(ItmMenuItemCond.class, PREFIX);
	
	public ItmMenuItemCond() {
		super();
	}
	
	private static final String A_MENUSEQNO = "menuSeqNo";
	private static final String A_IMGPATH = "imgPath";
	private static final String A_CATEGORYID = "categoryId";
	public static final String A_PACKAGEID = "packageId";
	public static final String A_PACKAGETYPE = "packageType";
	private static final String A_FORMID = "formId";
	...
	public static BaseObject toObject(Node node, BaseObject baseObj) throws Exception {
		...
		ItmMenuItemCond obj = null;
		if (node == null || !(baseObj instanceof ItmMenuItemCond))
			obj = new ItmMenuItemCond();
		else
			obj = (ItmMenuItemCond)baseObj;
	...
	public static ItmMenuItemCond[] add(ItmMenuItemCond[] objs, ItmMenuItemCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
			size = objs.length;
		ItmMenuItemCond[] newObjs = new ItmMenuItemCond[size+1];
		int i;
		for (i=0; i<size; i++)
			newObjs[i] = objs[i];
		newObjs[i] = obj;
	...
	public static ItmMenuItemCond[] remove(ItmMenuItemCond[] objs, ItmMenuItemCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
	...
	public static ItmMenuItemCond[] left(ItmMenuItemCond[] objs, ItmMenuItemCond obj) {
		...
		if (idx < 1)
			return objs;
		ItmMenuItemCond[] newObjs = new ItmMenuItemCond[objs.length];
		for (int i=0; i<objs.length; i++) {
			if (i == idx) {
	...
	public static ItmMenuItemCond[] right(ItmMenuItemCond[] objs, ItmMenuItemCond obj) {
		if (objs == null || objs.length == 0 || obj == null)
			return objs;
		int idx = -1;
		for (int i=0; i<objs.length; i++) {
