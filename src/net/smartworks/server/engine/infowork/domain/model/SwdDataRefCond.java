...
public class SwdDataRefCond extends ClassObjectCond {

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(SwdDataRefCond.class);
	
	protected static final String PREFIX = "Swd";
	private static final String NAME = CommonUtil.toName(SwdDataRefCond.class, PREFIX);
	...
	public static BaseObject toObject(Node node, BaseObject baseObj) throws Exception {
		...
		SwdDataRefCond obj = null;
		if (baseObj == null || !(baseObj instanceof SwdDataRefCond))
			obj = new SwdDataRefCond();
		else
			obj = (SwdDataRefCond)baseObj;
	...
	public static SwdDataRefCond[] add(SwdDataRefCond[] objs, SwdDataRefCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
			size = objs.length;
		SwdDataRefCond[] newObjs = new SwdDataRefCond[size+1];
		int i;
		for (i=0; i<size; i++)
			newObjs[i] = objs[i];
		newObjs[i] = obj;
	...
	public static SwdDataRefCond[] remove(SwdDataRefCond[] objs, SwdDataRefCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
	...
	public static SwdDataRefCond[] left(SwdDataRefCond[] objs, SwdDataRefCond obj) {
		...
		if (idx < 1)
			return objs;
		SwdDataRefCond[] newObjs = new SwdDataRefCond[objs.length];
		for (int i=0; i<objs.length; i++) {
			if (i == idx) {
	...
	public static SwdDataRefCond[] right(SwdDataRefCond[] objs, SwdDataRefCond obj) {
		if (objs == null || objs.length == 0 || obj == null)
			return objs;
		int idx = -1;
		for (int i=0; i<objs.length; i++) {
