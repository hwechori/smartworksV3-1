...
public class SwdDomainCond extends ClassObjectCond 
{
	...
	private static final String NAME = CommonUtil.toName(SwdDomainCond.class, PREFIX);
	...
	public static final String A_FORMNAMELIKE = "formNameLike";
	...
	public String toAttributesString() {
		...
		appendAttributeString(A_FORMNAMELIKE, formNameLike, true, buf);
	...
	public static BaseObject toObject(Node node, BaseObject baseObj) throws Exception {
		...
		SwdDomainCond obj = null;
		if (baseObj == null || !(baseObj instanceof SwdDomainCond))
			obj = new SwdDomainCond();
		else
			obj = (SwdDomainCond)baseObj;
		...
		if (attrMap != null) {
			...
			Node formNameLike = attrMap.getNamedItem(A_FORMNAMELIKE);
			...
			if (formNameLike != null)
				obj.setFormNameLike(formName.getNodeValue());
			if (tableName != null)
...
//				obj.addField((SwdField)SwdField.toObject(childNode, null));
	...
	public static SwdDomainCond[] add(SwdDomainCond[] objs, SwdDomainCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
			size = objs.length;
		SwdDomainCond[] newObjs = new SwdDomainCond[size+1];
		int i;
		for (i=0; i<size; i++)
			newObjs[i] = objs[i];
		newObjs[i] = obj;
	...
	public static SwdDomainCond[] remove(SwdDomainCond[] objs, SwdDomainCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
	...
	public static SwdDomainCond[] left(SwdDomainCond[] objs, SwdDomainCond obj) {
		...
		if (idx < 1)
			return objs;
		SwdDomainCond[] newObjs = new SwdDomainCond[objs.length];
		for (int i=0; i<objs.length; i++) {
			if (i == idx) {
	...
	public static SwdDomainCond[] right(SwdDomainCond[] objs, SwdDomainCond obj) {
		if (objs == null || objs.length == 0 || obj == null)
			return objs;
		int idx = -1;
		for (int i=0; i<objs.length; i++) {
	...
	public void setFormNameLike(String formNameLike) {
		this.formNameLike = formNameLike;
	}
