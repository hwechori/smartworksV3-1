...
public class Opinion extends MisObject {

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(Opinion.class);

	protected static final String PREFIX = "Opn";
	private static final String NAME = CommonUtil.toName(Opinion.class, PREFIX);
	...
	public static BaseObject toObject(Node node, BaseObject baseObj) throws Exception {
		...
		Opinion obj = null;
		if (baseObj == null || !(baseObj instanceof Opinion))
			obj = new Opinion();
		else
			obj = (Opinion)baseObj;
	...
	public static Opinion[] add(Opinion[] objs, Opinion obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
			size = objs.length;
		Opinion[] newObjs = new Opinion[size+1];
		int i;
		for (i=0; i<size; i++)
			newObjs[i] = objs[i];
		return newObjs;
	}
	public static Opinion[] remove(Opinion[] objs, Opinion obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
	...
	public static Opinion[] left(Opinion[] objs, Opinion obj) {
		...
		if (idx < 1)
			return objs;
		Opinion[] newObjs = new Opinion[objs.length];
		for (int i=0; i<objs.length; i++) {
			if (i == idx) {
	...
	public static Opinion[] right(Opinion[] objs, Opinion obj) {
		if (objs == null || objs.length == 0 || obj == null)
			return objs;
		int idx = -1;
		for (int i=0; i<objs.length; i++) {
