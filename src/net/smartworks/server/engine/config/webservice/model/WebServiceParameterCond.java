...
public class WebServiceParameterCond extends MisObjectCond {

	private static final long serialVersionUID = 1L;
	private static Log logger = LogFactory.getLog(WebServiceParameterCond.class);
	
	protected static final String PREFIX = "Web";
	private static final String NAME = CommonUtil.toName(WebServiceParameterCond.class, PREFIX);
	...
	public WebServiceParameterCond() {
		super();
	}
	...
	public static WebServiceParameterCond[] add(WebServiceParameterCond[] objs, WebServiceParameterCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
			size = objs.length;
		WebServiceParameterCond[] newObjs = new WebServiceParameterCond[size+1];
		int i;
		for (i=0; i<size; i++)
			newObjs[i] = objs[i];
		newObjs[i] = obj;
	...
	public static WebServiceParameterCond[] remove(WebServiceParameterCond[] objs, WebServiceParameterCond obj) {
		if (obj == null)
			return objs;
		int size = 0;
		if (objs != null)
	...
	public static WebServiceParameterCond[] left(WebServiceParameterCond[] objs, WebServiceParameterCond obj) {
		...
		if (idx < 1)
			return objs;
		WebServiceParameterCond[] newObjs = new WebServiceParameterCond[objs.length];
		for (int i=0; i<objs.length; i++) {
			if (i == idx) {
	...
	public static WebServiceParameterCond[] right(WebServiceParameterCond[] objs, WebServiceParameterCond obj) {
		if (objs == null || objs.length == 0 || obj == null)
			return objs;
		int idx = -1;
		for (int i=0; i<objs.length; i++) {
