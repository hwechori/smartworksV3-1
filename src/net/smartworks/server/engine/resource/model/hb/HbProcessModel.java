...
/**
 * IProcessModel 하이버네이트 타입 구현
 * 
 * @author jhnam
 * @version $Id: HbProcessModel.java,v 1.1 2011/11/08 03:15:03 kmyu Exp $
 */
public class HbProcessModel implements IProcessModel, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if(!(obj instanceof HbProcessModel))
			return false;
		
		HbProcessModel model = (HbProcessModel)obj;
