...
////				
////			Map<String, WorkCategory> pkgCtgPathMap = getPkgCtgMapByPackageId(pkg);
...
////		}
////	}
//	protected static Map<String, WorkCategory> getPkgCtgMapByPackageId(PkgPackage pkg) throws Exception {
//		
//		String categoryId = pkg.getCategoryId();
//		if (CommonUtil.isEmpty(categoryId) || categoryId.equalsIgnoreCase(CtgCategory.ROOTCTGID))
//			return null;
